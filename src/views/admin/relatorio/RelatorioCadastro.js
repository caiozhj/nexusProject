    ...
    <Box width={900}>
      {/* <Card> */}
        <Accordion defaultIndex={[0]} allowMultiple>
          <Text as="b">Relatório Cadastro</Text>

          <AccordionItem>
            <h2>
              <AccordionButton>
                <Box as="span" flex="1" textAlign="left">
                  Relatorio de Moradores
                </Box>
                <AccordionIcon />
              </AccordionButton>
            </h2>
            ...
            <Stack spacing={4} align="center">
              <Flex>
                ...
                <FormControl flex={1}>
                  <FormLabel>Pesquisar por Morador</FormLabel>
                  <Input  width="400px" placeholder="Digite o nome do morador" />
                </FormControl>
